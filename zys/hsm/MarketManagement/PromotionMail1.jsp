...
<%
    ...
    String rymc = request.getParameter("rymc");//	人员名称/id
    ...
    try {
        ...
        if(gr4.size()>0){
            ...
            new BaseBean().writeLog("当前sl："+sl+",sl1:"+sl1+",sl2:"+sl2+",sl3:"+sl3+",sl5:"+sl5+",sl6:"+sl6+",fzrsl:"+fzrsl);
            zsl = sl+sl1+sl2+sl3+sl5+sl6+fzrsl;
            gr.addAll(id1);
            gr.addAll(id2);
            gr.addAll(id3);
            gr.addAll(id4);
